...
})({"fjJ7T":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "db14f4d4038d8b8e";
"use strict";
...
class Carousel {
    ...
    getImgContainerLength() {
        ...
        return this.imgContainer.style.width = `${this.carouselWidth / 3 * this.imgs.length}px`;
    }
    initTravel() {
        window.addEventListener('load', ()=>{
    ...
    onPrevious() {
        ...
        this.btnLeft.addEventListener('click', ()=>{
            ...
            this.imgContainer.style.transform = `translateX(${this.carouselTransform + this.carouselWidth / 3}px)`;
