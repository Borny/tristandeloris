...
console.log('main js');
// SERVICE WORKER
if ('serviceWorker' in navigator) navigator.serviceWorker.register(require("93b4f2a1d05d141d")).then(()=>{
...
},{"93b4f2a1d05d141d":"aB9Pt"}],"aB9Pt":[function(require,module,exports) {
module.exports = require('./helpers/bundle-url').getBundleURL('7S8md') + "sw.js" + "?" + Date.now();
...
},{}]},["cgLB2","iJDgK"], "iJDgK", "parcelRequire3cd7")
